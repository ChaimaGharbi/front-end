...
export default function () {
  ...
  const [client_id, setId] = useState(localStorage.getItem("client_id"));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      .put('http://localhost:3030/client/update/'+client_id, {
  ...
  useEffect(()=>{
    axios
    .get('http://localhost:3030/client/'+client_id, {
      ...
      <div className="container">
        <div className={`${styles.d_flex} justify-content-center align-items-center ${styles.profile}`}>
          ...
          <div className={styles.profile_info}>
            <form className={styles.modifier_form} onSubmit={handleSubmit} action={`/client/update/${client_id}`} method='PUT'>
              <div className="mb-1">
